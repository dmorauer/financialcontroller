...
export default function WhatsAppSettingsPage() {
  ...
  return <main className="settingsPage"><section className="settingsShell"><div className="settingsTop"><Link href="/">← Voltar ao painel</Link><span className="brand"><i className="brandMark">B</i> BoraGrana</span></div><header><div><p className="eyebrow">CONFIGURAÇÕES</p><h1>WhatsApp</h1><p>Conecte e controle o bot financeiro.</p></div><button className="secondaryButton" onClick={() => void loadStatus()}>Atualizar status</button></header>
